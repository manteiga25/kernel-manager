...
def set_cpu_idle_governor(governador):
    try:
        with open(f"/sys/devices/system/cpu/cpuidle/current_governor_ro", "w") as gov:
...
class cpu_idle:
    ...
    def cpu_clocksource_frame(self):
        ...
        ctk.CTkLabel(self.cpu_clocksource_f, text="Clocksource mode: ").grid(column=0, row=2, pady=5)
        ...
        self.modos_clocksource.grid(column=1, row=2, padx=10, pady=5)
        ok.grid(column=2, row=2, padx=10, pady=5)
    ...
    def cpu_idle_frame(self):
        ...
        ctk.CTkLabel(self.frame_cpu_idle, text="Governador idle: ").grid(column=0, row=2, pady=5)
        ...
        self.governadores_idle.grid(column=1, row=2, padx=10, pady=5)
        ok.grid(column=2, row=2, padx=10, pady=5)
